...
def iou(box1, box2):
    ...
    xi1 = tf.math.maximum(box1[0], box2[0])
    yi1 = tf.math.maximum(box1[2], box2[2])
    xi2 = tf.math.minimum(box1[1], box2[1])
    yi2 = tf.math.minimum(box1[3], box2[3])
...
def model(X_train, Y_train, X_test, Y_test, learning_rate = 0.0001,
    ...
    with tf.Session() as sess:
        ...
        save_path = saver.save(sess, "/home/vicky/Desktop/model/model.ckpt")
